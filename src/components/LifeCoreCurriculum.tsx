...
const workshopDescriptions = {
  ...
  "Water for Life Project": "Raise and donate money to provide a lifetime of fresh water",
  ...
  "Escape Room Expert": "Use uplifting language to beat an escape room with your team",
  ...
  "Code & Create Team": "Code self-driving cars, drones, and video games with a programming partner",
  ...
  "Outdoor Chef: Plan and cook my own meals on a 3-day camping trip": "Plan and cook your own meals on a 3-day camping trip",
  "FBI Fitness Challenge": "Pass the FBI physical fitness test requirements",
  "Pirates & Sailing Crew": "Learn to sail in six weeks to earn a trip to the Bahamas",
  ...
  "Global Teaching Ambassador": "Teach kids across the world to use 2-Hour Learning",
